  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      files: {
        ...
        src: ["js/src-bundle/*.js", "!js/src-bundle/bundle.*"],
    ...
    uglify: {
      bundle: {
        ...
        files: {
          "js/dist/<%= pkg.name %>-bundle.min.js":
            "js/src-bundle/bundle-compiled.js",
        },
      },
      single: {
        options: {
    ...
    clean: {
      ...
      bundle: {
        files: {
          src: ["js/src-bundle/*-compiled.js", "js/src-bundle/*-compiled.js.map"],
        },
      },
      single: {
        files: {
          src: [
            "js/src-single/*-compiled.js",
            "js/src-single/*-compiled.js.map",
          ],
        },
      },
    },
